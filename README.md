About pangaea-feedstock
=======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pangaea-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/snowman2/pangaea

Documentation: http://pangaea.readthedocs.io
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4549&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pangaea-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pangaea` can be installed with `conda`:
...
```
mamba install pangaea
```

It is possible to list all of the versions of `pangaea` available on your platform with `conda`:
...
```
mamba search pangaea --channel conda-forge
```
...
mamba repoquery search pangaea --channel conda-forge

# List packages depending on `pangaea`:
mamba repoquery whoneeds pangaea --channel conda-forge

# List dependencies of `pangaea`:
mamba repoquery depends pangaea --channel conda-forge
```
